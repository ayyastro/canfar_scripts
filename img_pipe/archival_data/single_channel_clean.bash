...
vmkdir vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}

vcp ${TMPDIR}/proc_${channel}/casa*.log vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}

vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.image.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/
vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.mask.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/
vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.model.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/
vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.psf.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/
vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.residual.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/

vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.flux.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/

vcp ${TMPDIR}/proc_${channel}/${ms_name%.ms}.clean.flux.pbcoverage.tar.gz vos:MWSynthesis/VLA/archival/clean_channels_test/channel_${channel}/
